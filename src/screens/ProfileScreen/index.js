...
import {Text, View, SafeAreaView, Image, ScrollView, useColorScheme} from 'react-native';
  ...
  <SafeAreaView style={styles.container}>
    <ScrollView showsVerticalScrollIndicator={false}>
      ...
      <View style={styles.infoContainer}>
        ...
        <Text style={[styles.text, { color: COLORS.font_secondary, fontSize: 14 }]}>
          SP18-BCS-023
        </Text>
        <Text style={[styles.text, { color: COLORS.font_secondary, fontSize: 14 }]}>
          Student
      ...
      <View style={styles.statsContainer}>
        ...
        <View
          style={[
            styles.statsBox,
            { borderColor: COLORS.icon, borderLeftWidth: 1, borderRightWidth: 1 },
          ]}
        >
      ...
      <View style={{ alignItems: "center" }}>
        <View style={styles.recentItem}>
          ...
          <View style={{ width: 250 }}>
            <Text
              style={[styles.text, { color: COLORS.font_secondary, fontWeight: "300" }]}
            >
